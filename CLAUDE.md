...
1. **Decompose to fundamentals** — Pool must be zero-token because 1.5B cannot do math; 33k ctx means every system token is cheap. Prove constraint before adding mechanism.
